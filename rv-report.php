...
<body>
    ...
    <!-- section banner -->
    <section class="hero other-page-hero about-us-hero rv-hero">
        <div class="container">
            <div class="hero-content" data-aos="zoom-in" data-aos-delay="600" data-aos-duration="500">
                <h1>Rv Car <br> <span>Vehicle Report</span></h1>
            </div>
        </div>
    </section>
    <!-- End section -->
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="img-box-content">
                                        <img src="assets/images/rv-report-1.png" alt="">

                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="img-box-content">
                                        <img src="assets/images/rv-report-2.png" alt="">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="img-box-content" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="500">
                        <img src="assets/images/rv-card-img-1.png" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="img-box-content" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="500">
                        <img src="assets/images/rv-card-img-2.png" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="img-box-content" data-aos="zoom-in" data-aos-delay="200" data-aos-duration="500">
                        <img src="assets/images/rv-card-img-3.png" alt="">
                    </div>
                </div>
            </div>
